...
const floorplanComponent= ({totalCount,setTotalCount}) => {
    const [AdultCount,setAdultCount]=useState(0)
    const [ChildCount,setChildCount]=useState(0)
    const [InfantCount,setInfantCount]=useState(0)
    const [PetCount,setPetCount]=useState(0)
    const [GuestbarAnimation,setGuestbarAnimation]=useState(true)
  ...
  return (
    <div className='Guestbar ${GuestbarAnimation ? Animation : ""} '>
