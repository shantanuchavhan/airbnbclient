...
const Card = ({ userName, image, location, price,  setCurrentProduct,  roomData,wishlist }) => {
      ...
      <div onClick={setProduct}  className={`card ${isLoading ? 'loading' : ''}`}>
        <div className='Image-Detail'>
          ...
          <div onClick={addToWishList} className="wishlistIcon">
              <svg className={wishlist.include(roomData._id)? 'pinkWishListColor':''} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
